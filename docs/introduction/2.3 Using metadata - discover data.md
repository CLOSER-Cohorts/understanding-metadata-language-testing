...
!!! example ""
    ...
    **Intended Learning Outcome**
    ...
    - Describe the role of data repositories and data catalogues in research
    - Use search and filter tools to discover data in catalogues
    - Explain how metadata supports data discovery (e.g. search and filtering)
    - Use codebooks and data dictionaries to interpret datasets
    - Use metadata to assess the relevance and trustworthiness of data
    - Use metadata to support research activities
...
<details>
<summary><b>Everyday examples of using metadata for finding </b></summary>
<p></p> 
...
!!! abstract ""
    ...
    ??? success "The data catalogue we chose ..."
        ...
        You can see the UK Data service listed on [re3data here](https://www.re3data.org/repository/r3d100010230) and [Fairsharing here](https://fairsharing.org/FAIRsharing.1ky0cs).
...
!!! abstract ""
    ...
    === "Search"
        For example you could put 'water quality' in the search bar ...
        <p align="center">
...
=== "**Codebooks**"
    ...
    For example, the codebook from the 2024 research project "Dietary Intake in Scotland's Children (DISH)"<sup>[7]</sup> gives information on abbreviations used in the research, the variables (such as data type, unit of measurement and description), the codes and categories used in the survey.
    <p align="center">
...
=== "**Data dictionaries**"
    ...
    !!! quote "CODATA defines Data dictionary as a ..."
        _'collection of descriptions of the data objects or items in a data model. After each data object or item is given a descriptive name, its relationship is described (or it becomes part of some structure that implicitly describes relationship), the type of data (such as text or image or binary value) is described, possible predefined values are listed, and a brief textual description is provided. This collection can be organised for reference into a data dictionary.'_ <sup>[9]</sup>

    The data dictionary for the DISH project lists the different variables in a survey and a short label to describe the variable<sup>[7]</sup>. It contains more high level information than a codebook as it does not include information such as unit of measurement, codes or categories used.
...
!!! question "   "
    Once you have _found_ the data, _understood_ it and _assessed_ its trustworthiness and relevance to your work, you can now decide what you want to do with it. How can metadata help us take action in our research process?
...
- Find out what other studies the researchers have carried out by searching their ORCID iD or looking at associated studies
...
!!! question ""
    ...
    - Data repositories and data catalogues are the same thing.
        ...
        ??? success "Reveal answer"
            ...
            **FALSE** Repositories store the actual data, while catalogues store metadata to help users discover data.

    - Data catalogues store the actual research data.

        ??? success "Reveal answer"

            **FALSE** Data catalogues contain metadata records and point users to where the data is held.

    - You can filter a data catalogue without metadata.

        ??? success "Reveal answer"

            **FALSE** Search and filter functions rely on metadata.

    - A data dictionary includes analysis results and conclusions.

        ??? success "Reveal answer"

            **FALSE** - A data dictionary describes variables and data structure, not interpretations or research findings.
...
- <sup>[9]</sup> CODATA (2025) Research Data Management Terminology: Data dictionary https://terms.codata.org/rdmt/data-dictionary
