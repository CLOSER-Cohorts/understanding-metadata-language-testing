...
!!! example ""
    ...
    **Intended learning outcomes**
    ...
    - Identify the stages of the research lifecycle
    - Describe key research activities across the lifecycle
    - Identify where metadata is created in the research lifecycle
    - Explain why metadata is important at different stages of the lifecycle

## Research lifecycle

In this unit, we'll explore how metadata fits into the research lifecycle, helping us to conduct research activities.

The research lifecycle is the whole period of a research project from inception to publication and beyond. People also refer to the [research data lifecycle](https://terms.codata.org/rdmt/research-data-lifecycle) which has a more specific focus on a project's data, covering the 'period of time that research data exists ... [describing] the flow of research data'<sup>[1]</sup> .
...
!!! abstract ""
    ...
    - Confirm funding streams for the research project
    - Select research methodology
    - Outline usage and access of produced data
    - Consider ethical and legal compliance of the research
...
=== "**Analysis**"
    ...
    * Apply statistical tests and models to gain findings from the data
...
!!! question "How might you use metadata from other research projects to help discover research in the Research Design and Data Collection stages?"
    ...
    Expand the boxes below to explore how we can use metadata to find, understand and access data in the Research Design and Data Collection stages.
    
    ??? tip "Metadata can help us find research"
...
!!! abstract ""
    ...
    ??? success "Answers"
        ...
        **Abstract**
        ...
        - You would most likely write an abstract at the publication stage as it is a tool to help other people get an overview of your entire research effort.</li>
...
!!! quote "CODATA defines [provenance as](https://terms.codata.org/rdmt/provenance) ..."
...
!!! abstract ""
    ...
    **Comparing provenance metadata**
    ...
    We can see that the variable is derived however, we can't see which variables it was derived from and how it was calculated. We also don't know which dataset the variable belongs to. This limits our understanding of how the data was produced and reduces its provenance. 
...
You can see an example of good data provenance for derived variables in the [National Child Development Study<sup>[6]</sup>](https://discovery.closer.ac.uk/item/uk.cls.ncds/524c8f92-493f-4660-90c4-0aa7ac3d2640/141) on CLOSER Discovery<sup>[7]</sup>. For example, examine the following variables...
    ...
    **True or false...**
    ...
    - Metadata should be created only after the research project is completed.
        ...
        ??? success "Reveal answer"
            ...
            **FALSE** Metadata should be created at the start of a project and updated throughout the research lifecycle. Creating it early ensures data is well organised, documented, and easier to manage and share.

    - Another research project's metadata can help us in our own research study.

        ??? success "Reveal answer"

            **TRUE** Reviewing metadata from other studies helps you discover relevant datasets and understand how data was collected and structured, which can inform your own research design and analysis.

    - Metadata is only useful during the data collection phase of research.

        ??? success "Reveal answer"

            **FALSE** Metadata supports all stages of the research lifecycle, including planning, data collection, analysis, sharing, and long-term preservation.

    - Provenance information is useful for assessing the reliability and quality of data.

        ??? success "Reveal answer"

            **TRUE** Provenance metadata records how data was created, processed, and modified. This helps researchers evaluate the data’s quality, reliability, and suitability for reuse.



---
## Resources
You can find more 'Research Data Lifecycle' resources on the [resources page](<../resources.md#research-data-lifecycle>).
...
- <sup>[8]</sup> University of London, Institute of Education, Centre for Longitudinal Studies. (2024). National Child Development Study: Age 50, Sweep 8, 2008-2009. [data collection]. 3rd Edition. UK Data Service. SN: 6137, DOI: http://doi.org/10.5255/UKDA-SN-6137-2
  - CLOSER (2025) '[(Derived) No. of fostered children left the hh since last sweep](https://discovery.closer.ac.uk/item/uk.cls.ncds/372a1d9f-34ef-4b3e-939f-a2e9c1a7c288) in Age 50 Survey, National Child Development Study' (2008) CLOSER Discovery
- <sup>[9]</sup> University of London, Institute of Education, Centre for Longitudinal Studies. (2024). National Child Development Study: Age 50, Sweep 8, 2008-2009. [data collection]. 3rd Edition. UK Data Service. SN: 6137, DOI: http://doi.org/10.5255/UKDA-SN-6137-2
  - CLOSER (2025)'[(Derived) BMI at Interview (age 44)](https://discovery.closer.ac.uk/item/uk.cls.ncds/b5919e90-46db-4a2a-81b9-58ecdcb889e8) in Age 44 Biomedical Survey (2002), National Child Development Study' CLOSER Discovery
