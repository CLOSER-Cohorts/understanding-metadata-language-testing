...
!!! example ""
    ...
    **Intended Learning Outcome**
    ...
    - Describe what research data is and how it can be represented
    - Identify the characteristics of research data
    - Explain the relationship between concept, measure, and data
...
!!! question "What data is available in the weather app screenshot below<sup>[1]</sup>?"
    ...
    <p align="center">
    <img src="../img/met_office_image.png" alt="Alt Text" width="215" height="500">
    </p>
    ...
    <p align="center">
    <img src="../img/met_office_image_circle.png" alt="Alt Text" width="215" height="500"> 
    </p>
...
!!! quote "Taking a more business context, IBM defines data as ..."
...
!!! abstract ""
    ...
    If you're a researcher who wants to record the age of every participant in a study, what is the concept &rarr; measure &rarr; data?

    ??? question "What is **the concept** we want to capture?"
    
        Age of person.

    ??? question "How do we **measure** age?"
    ...
    ??? question "How would we represent that **data**?"
        ...
        We could use years, months, days, minutes or seconds to record data about age. If we used one of these units of measurement, we would create _numeric_ data. If we use years as a unit of measurement, the valid range of numbers that would be acceptable would start from 0 (as your age cannot be negative) to roughly 115, based on the average lifespan of a person. The numeric data collected in our research will make up our dataset.
...
:arrow_right: If you're currently doing research, try to identify the concept &rarr; measure &rarr; data for your work.
...
!!! question ""
    ...
    1. **Complete the missing step: Concept → ??? → data**
    ...
    2. **True or false: different data using different units of measurement can convey the same information**

        ??? success "Reveal answer"

            **TRUE**
            
            The same concept can be measured in different units.
            For example, temperature can be expressed in degrees Celsius or Fahrenheit, 
            and time spent on an activity can be measured in minutes or hours.

    3. **What role does data have in research?**

        ??? success "Reveal answer"

            Data is used as evidence in the research process and supports 
            and validates research findings.
---
## Resources
You can find more 'Research Data' resources on the [resources page](<../resources.md#research-data>).

---

## References

- <sup>[1]</sup> Met Office (2026) _Met Office Weather App_ [Mobile app]. Available at: App Store or Google Play Store https://www.metoffice.gov.uk/
...
- <sup>[6]</sup> [CODATA (2025) RDM Terminology: Research data](https://terms.codata.org/rdmt/research-data)
