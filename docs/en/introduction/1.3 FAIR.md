...
!!! example ""
    ...
    **Intended Learning Outcomes**
    ...
    - Explain the role and benefits of FAIR in research
    - Identify how research practices and tools support the implementation of FAIR
...
!!! tip "The FAIR principles outline the features that make data good quality data." 

    FAIR proposes data should be...

    - **F**indable: other people can find your data and data documentation.
...
You can watch a short video to gain an overview of FAIR in research<sup>[3]</sup>.
...
=== "**F**indable"
    ...
    **What you could do ...**
    ...
    - Deposit your data in a trusted repository or archive so people can find your data when searching these sites. The repository will create a Digital Object Identifier (DOI) for your data, which is a persistent and unique link to your work. The DOI can be used to cite your data, making it easy to find. The repository will also use metadata to organise different datasets so they are findable (we will look at data repositories in more detail in [unit 2.3.)](<2.3 Using metadata - discover data.md>)<sup>[6]</sup>
    - Some repositories may create a Persistent Identifier (PID) for individual people, however you can also create and manage a PID for yourself using [ORCID iD](https://orcid.org/). This can help ensure you are correctly attributed in your research by other researchers. You should also reference your ORCID iD when documenting your own work.
    ...
    **Resources to help you implement the 'Findable' principle in your work...**
    ...
    - Explore guidance on deciding where to deposit your data on [DCC here.](https://www.dcc.ac.uk/guidance/how-guides/where-keep-research-data)
    ...
    - Create a Persistent Identifier for yourself with [ORCID iD.](https://orcid.org/)
...
=== "**I**nteroperable"
    ...
    **Resources to help you implement the 'Interoperable' principle in your work...**
    ...
    - Clean your dataset with open source tools such as [Open Data Editor](https://okfn.org/en/projects/open-data-editor/) or [OpenRefine](https://openrefine.org/), correcting any errors found in the dataset.
...
!!! question "What was a recurring feature across all four principles?"

    <mark>**Metadata**</mark>

    Documenting your data with metadata is one of the most effective ways of implementing the FAIR principles in your research. In [unit 2.1](<2.1 Introduction to metadata.md>) and [2.2](<2.2 Metadata in the research lifecycle.md>), we'll explore what metadata is and how it's used in research.
...
??? tip "**Maximises the value and use of data**"
...
??? tip "**Improves the quality, accuracy and security of data**"
...
??? tip "**Makes research processes transparent and trustworthy**"
    ...
    **True or false...**
    ...
    - FAIR data must always be open and free to access.
        ...
        ??? success "Reveal answer"
            ...
            **FALSE** Data can be restricted as long as access conditions are clear.

    - Search engines and registries play a key role in making data findable.

        ??? success "Reveal answer"

            **TRUE** They index metadata, helping users find datasets.

    - I can make my data FAIR without capturing metadata for my study.

        ??? success "Reveal answer"

            **FALSE** Metadata is essential for finding, understanding, and reusing data.

    - Data does not need a unique identifier to be considered findable.

        ??? success "Reveal answer"

            **FALSE** Persistent identifiers (e.g. DOIs) are key to reliably locating data.

    - FAIR principles encourage the use of community standards for metadata.

        ??? success "Reveal answer"

            **TRUE** Shared standards improve interoperability and reuse across studies.

---
## Resources
You can find more 'FAIR' resources on the [resources page](<../resources.md#fair>).
...
- <sup>[3]</sup> Martínez-Lavanchy, P.M., Hüser, F.J., Buss, M.C.H., Andersen, J.J., Begtrup, J.W. (2019). ‘FAIR Principles’. In: Holmstrand, K.F., den Boer, S.P.A., Vlachos, E., Martínez-Lavanchy, P.M., Hansen, K.K. (Eds.), Research Data Management (eLearning course) [Online video](https://www.youtube.com/watch?v=5OeCrQE3HhE)
...
- <sup>[7]</sup> DCC (2015) 'How to Cite Datasets and Link to Publications DCC Guide' Available online: https://www.dcc.ac.uk/guidance/how-guides/cite-datasets
